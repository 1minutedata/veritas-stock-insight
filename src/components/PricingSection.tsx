    ...
    <section id="pricing" className="py-24 relative bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
          {/* Free Trial */}
          <Card className="p-8 relative bg-card border border-border/20 hover:shadow-lg transition-all duration-300">
          ...
          {/* Pro Plan */}
          <Card className="p-8 relative bg-primary border-none shadow-xl scale-105">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="bg-card text-primary px-4 py-1 rounded-full text-sm font-medium border border-border/20">
                Most Popular
              </span>
            </div>
            <div className="text-center">
              ...
              <Link to="/auth">
                <Button className="w-full rounded-full bg-primary-foreground text-primary hover:bg-primary-foreground/90">
                  Start Pro Trial
                </Button>
              </Link>
            </div>
